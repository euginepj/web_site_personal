...
class Por extends CI_Controller {
	...
	public function index(){
        ...
        $this->load->view('fronted_inicio/footer',["datos_personales"   => $this->Cirujano_model->ver_datos_contacto()->result(),"desarrollado" => "Desenvolvido por"]);
	}
	...
	public function procedimientos(){
		...
		$this->load->view('analyticstracking');		
		$this->load->view('fronted_inicio/footer',["datos_personales"   => $this->Cirujano_model->ver_datos_contacto()->result(),"desarrollado" => "desenvolvido pela"]);
	}
