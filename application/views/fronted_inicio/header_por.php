		...
		<div class="container clearfix">
			...
			<div id="primary-menu-trigger"><i class="icon-reorder"></i></div>
					...
					<div id="logo">
						...
						<a href="<?=$this->config->base_url();?>index.php/por/index" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><img src="<?=$this->config->base_url();?>fronted_inicio/foto/logo1.png" alt="Julio Reyes logo"></a>
					</div><!-- #logo end -->
