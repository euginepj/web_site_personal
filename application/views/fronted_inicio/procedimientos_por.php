                ...
                foreach ($procedimientos as $proc) {
                    ...
                    if($count % 2 != 0){
                        ...
                        <section id="<?=$ID;?>" class="page-section">
                            ...
                            <div class="col_half nobottommargin center" id="visual_tel" style="display:none;">

                                <img src="<?=$this->config->base_url();?>fronted_inicio/procedimientos/<?=$proc->img_principal_procedimiento;?>" alt="Image" data-animate="fadeInRight" style="">
                            ...
                            <?php /***Visual tel****/ ?>
                            <div class="col_half nobottommargin center" id="hidden_tel">
                            ...
                            <div class="section nobg topmargin-lg noborder bottommargin-sm">
                                <div class="container clearfix">
                                    ...
                                    <div class="col_half bottommargin-sm center col_last">
                                        ...
                                        <img src="<?=$this->config->base_url();?>fronted_inicio/procedimientos/<?=$proc->img_principal_procedimiento;?>" alt="Image" data-animate="fadeInLeft"  style="">
