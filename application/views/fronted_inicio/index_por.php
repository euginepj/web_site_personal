							...
							foreach ($procs_inicio as $pro) {
								...
								<div class="feature-box media-box">
									<div class="fbox-media">
										<a href="<?=$this->config->base_url();?>index.php/por/procedimientos#<?=$pro->titulo?>"><img src="<?=$this->config->base_url();?>fronted_inicio/procedimientos/<?=$pro->img_principal_procedimiento; ?>" alt="Why choose Us?" style="width:320px;height:240px;"></a>
									</div>
									<div class="fbox-desc">
				...
				<section id="section-testimonials" class="page-section topmargin-lg">
					...
					<div class="container clearfix">
						...
						<div class="heading-block center">
							...
							<span>Isto é o que meus pacientes dizem.</span>
						</div>
					...
					<script type="text/javascript">
						...
						$('#google-map').gMap({
							...
							{
								address: "<?=( isset( $coordenadas ) ? $coordenadas : 'La Santísima Trinidad, Bolivia'  );?>",
								html: '<div style="width: 300px;"><h4 style="margin-bottom: 8px;">Oi <span>Bemvindo.</span></h4><p class="nobottommargin"> Exatamente neste ponto, você pode encontrar meu consultório.</p></div>',							
								icon: {
...
.sidebar{padding-top:0px !important;}
								...
								<div class="sidebar col_last nobottommargin" style="padding-top:6em;">
									...
									<address>
										<strong style="font-size:1.16em;">Endereço:</strong><br>
