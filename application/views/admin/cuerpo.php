		...
		<div class="tab-pane" id="contacto_datos" style="padding:25px;">
			...
			if ( $datos_contacto->result() ) {
				foreach ($datos_contacto->result() as $dato) {
					$coordenas = $dato->coordenadas_mapa;
			...
			<form id="" action="<?=$this->config->base_url()?>index.php/admin/datos_contacto" method="post">
				...
				<p>Coordenadas Del mapa principal:</p>
				<input type="text" class="form-control datos_trigger" id="direccion" name="coordenadas" maxlength="200" value="<?=($coordenas);?>">
				...
				<p>Telefono:</p>
				<input type="text" class="form-control datos_trigger" id="telefono" name="telefono" maxlength="200" value="<?=($telefono);?>">

				<input type="hidden" class="form-control datos_trigger" id="fax" name="fax" maxlength="12" value="<?=($fax);?>">

				<p>Facebook:</p>
				<input type="text" class="form-control datos_trigger" id="facebook" name="facebook" maxlength="200" value="<?=($facebook);?>">

				<input type="hidden" class="form-control datos_trigger" id="twitter" name="twitter" maxlength="200" value="<?=($twitter);?>">

				<p>Instagram:</p>
				<input type="text" class="form-control datos_trigger" id="instagram" name="instagram" maxlength="200" value="<?=($instagram);?>">

				<input type="hidden" class="form-control datos_trigger" id="gloogleplus" name="gloogleplus" maxlength="200" value="<?=($gloogleplus);?>">
