...
class Cirujano_model extends CI_Model{
	...
	public function insert_galeria($nombreArchivos,$num_archivos){
		...
		for($i=0; $i < $num_archivos; $i++){ /*$insertar_file=*/
		   ...
		   public function cambiar_datos($coordenadas,$direccion,$email,$clave_email,$telefono,$fax,$facebook,$twiiter,$instagram,$googlepluss){
		   	$this->db->query("update datos_contacto set coordenadas_mapa = '$coordenadas', direccion = '$direccion', email = '$email' , clave_email = '$clave_email' , telefono ='$telefono' ,fax ='$fax' ,facebook ='$facebook' ,twitter ='$twiiter' ,instagram ='$instagram' ,googlepluss ='$googlepluss'  where id_datos_contacto = 1 ");
		   }
